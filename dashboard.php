...
//Asignamos funciones a cada una de las variables
    ...
    <div class="col-3">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <img class="img-fluid" src="./img/dinero.png" alt="">
                    </div>
                </div>
    ...
    <div class="col-3">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <img class="img-fluid" src="./img/clientes.png" alt="">
                    </div>
                </div>
    ...
    <div class="col-3">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <img class="img-fluid" src="./img/clientes-recientes.png" alt="">
                    </div>
                </div>
    ...
    <div class="col-3">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <img class="img-fluid" src="./img/clientes-fieles.png" alt="">
                    </div>
                </div>
